  ...
  while (true) {
    ...
    if (opcao == 9) {
      console.log(
        ...
        "\nBANCO DA HORDA - GOBLINS, GOBLINS, GOBLINS! O MELHOR SERVIÇO DE KALIMDOR!"
      );
      sobre();
    ...
    switch (opcao) {
      ...
      case 3: //Consultar a existência de uma conta
        console.log(
          colors.fg.redstrong,
      ...
      case 6: //Saque
        ...
        console.log("Digite o valor do Saque (Gold): ");
      ...
      case 7://Deposito
        ...
        console.log("Digite o valor do Deposito (Gold): ");
        valor = readlinesync.questionFloat("");
      ...
      case 8://Transferir
        ...
        console.log("\nDigite o valor do Deposito (Gold): ");
        valor = readlinesync.questionFloat();
